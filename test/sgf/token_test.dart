  ...
  group('Tokenizer', () {
    ...
    test('should take escaping values into account', () {
      ...
      var expected = [
        Token(TokenType.parenthesis, '(', 0, 0, 0, 0 / len),
        Token(TokenType.semicolon, ';', 0, 1, 1, 1 / len),
        Token(TokenType.propIdent, 'C', 0, 2, 2, 2 / len),
        Token(TokenType.cValueType, '[hello\\]world]', 0, 3, 3, 3 / len),
        Token(TokenType.semicolon, ';', 0, 17, 17, 17 / len),
        Token(TokenType.propIdent, 'C', 0, 18, 18, 18 / len),
        Token(TokenType.cValueType, '[hello\\\\]', 0, 19, 19, 19 / len),
        Token(TokenType.semicolon, ';', 0, 28, 28, 28 / len),
        Token(TokenType.propIdent, 'C', 0, 29, 29, 29 / len),
        Token(TokenType.cValueType, '[hello]', 0, 30, 30, 30 / len),
      ...
      expected = [
        ...
        Token(TokenType.semicolon, ';', 0, 1, 1, 1 / len),
        Token(TokenType.propIdent, 'C', 0, 2, 2, 2 / len),
        Token(TokenType.cValueType, '[\\];B[aa]', 0, 3, 3, 3 / len),
        Token(TokenType.semicolon, ';', 0, 12, 12, 12 / len),
        Token(TokenType.propIdent, 'W', 0, 13, 13, 13 / len),
        Token(TokenType.cValueType, '[bb]', 0, 14, 14, 14 / len),
    ...
    test('should allow lower case properties', () {
      ...
      final expected = [
        Token(TokenType.parenthesis, '(', 0, 0, 0, 0 / len),
        Token(TokenType.semicolon, ';', 0, 1, 1, 1 / len),
        Token(TokenType.propIdent, 'CoPyright', 0, 2, 2, 2 / len),
        Token(TokenType.cValueType, '[blah]', 0, 11, 11, 11 / len),
    ...
    test('should return invalid tokens', () {
      ...
      final expected = [
        ...
        Token(TokenType.semicolon, ';', 0, 1, 1, 1 / len),
        Token(TokenType.propIdent, 'C', 0, 2, 2, 2 / len),
        Token(TokenType.cValueType, '[hi]', 0, 3, 3, 3 / len),
        Token(TokenType.invalid, '%', 0, 7, 7, 7 / len),
        Token(TokenType.cValueType, '[invalid]', 0, 8, 8, 8 / len),
        Token(TokenType.parenthesis, ')', 0, 17, 17, 17 / len),
      ];
      expect(DeepCollectionEquality().equals(actual, expected), isTrue);
    });
